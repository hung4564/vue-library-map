((typeof self !== 'undefined' ? self : this)["webpackChunkmap_vue_libary"] = (typeof self !== 'undefined' ? self : this)["webpackChunkmap_vue_libary"] || []).push([[223],{
...
var __WEBPACK_AMD_DEFINE_RESULT__;__webpack_require__(2262);__webpack_require__(4506);__webpack_require__(3048);__webpack_require__(7461);__webpack_require__(6699);/**
 * @license
...
!function (t, e) {
  ...
  return function (t) {
    ...
    function n(t, e, i, n, o, r, s, a) {
      ...
      e && (h.render = e, h.staticRenderFns = i, h._compiled = !0), n && (h.functional = !0), r && (h._scopeId = "data-v-" + r);
      var c;
      if (s ? (c = function (t) {
    ...
    var l = function () {
      ...
      return i("div", {
        staticClass: "vdr",
        class: (t.active || t.isActive ? "active" : "inactive") + " " + (t.contentClass ? t.contentClass : ""),
        ...
        style: t.sizeStyle
      }, [t._t("default")], 2), t._v(" "), t._l(t.sticks, function (e) {
        return i("div", {
          ...
          on: {
            mousedown: function (i) {
              i.stopPropagation(), i.preventDefault(), t.stickDown(e, i);
            },
    ...
    var d = {
      ...
      methods: {
        ...
        move: function (t) {
          if (this.stickDrag || this.bodyDrag) {
            ...
            var e = void 0 !== t.pageX ? t.pageX : t.touches[0].pageX,
                ...
                o = {
              x: (n.pointerX - e) / this.parentScaleX,
              y: (n.pointerY - i) / this.parentScaleY
            };
        ...
        bodyMove: function (t) {
          var e = this.dimensionsBeforeMove,
              i = this.parentWidth,
              n = this.parentHeight,
              o = this.gridX,
              r = this.gridY,
          ...
          if (this.snapToGrid) {
            var f = !0,
                d = !0,
                p = h - Math.floor(h / r) * r,
                m = n - c - Math.floor((n - c) / r) * r,
                v = u - Math.floor(u / o) * o,
                g = i - l - Math.floor((i - l) / o) * o;
            p > r / 2 && (p -= r), m > r / 2 && (m -= r), v > o / 2 && (v -= o), g > o / 2 && (g -= o), Math.abs(m) < Math.abs(p) && (f = !1), Math.abs(g) < Math.abs(v) && (d = !1), h -= f ? p : m, c = n - a - h, u -= d ? v : g, l = i - s - u;
          }

          var b = this.rectCorrectionByLimit({
            newLeft: u,
            newRight: l,
            newTop: h,
            newBottom: c
        ...
        stickMove: function (t) {
          var e = this.currentStick,
              i = this.dimensionsBeforeMove,
              n = this.gridY,
              o = this.gridX,
              r = this.snapToGrid,
              s = this.parentHeight,
          ...
          switch (e[0]) {
            case "b":
              c = i.bottom + t.y, r && (c = s - Math.round((s - c) / n) * n);
              break;
          ...
          switch (e[1]) {
            case "r":
              l = i.right + t.x, r && (l = a - Math.round((a - l) / o) * o);
              break;

            case "l":
              u = i.left - t.x, r && (u = Math.round(u / o) * o);
          }

          var f = this.rectCorrectionByLimit({
            newLeft: u,
            newRight: l,
            newTop: h,
            newBottom: c
          ...
          if (u = f.newLeft, l = f.newRight, h = f.newTop, c = f.newBottom, this.aspectRatio) {
            var d = this.rectCorrectionByAspectRatio({
              newLeft: u,
              newRight: l,
              newTop: h,
              newBottom: c
            });
            u = d.newLeft, l = d.newRight, h = d.newTop, c = d.newBottom;
          }

          this.left = u, this.right = l, this.top = h, this.bottom = c, this.$emit("resizing", this.rect);
        },
        stickUp: function () {
        ...
        calcResizeLimits: function () {
          ...
          this.aspectRatio && (h / a > t ? a = h / t : h = t * a);
          var u = {
            left: {
              min: c,
              max: r + (e - h)
          ...
          if (this.aspectRatio) {
            var l = {
              left: {
                min: r - Math.min(o, n) * t * 2,
                max: r + (i - a) / 2 * t * 2
              },
              right: {
                min: s - Math.min(o, n) * t * 2,
                max: s + (i - a) / 2 * t * 2
              },
              top: {
                min: o - Math.min(r, s) / t * 2,
                max: o + (e - h) / 2 / t * 2
              },
              bottom: {
                min: n - Math.min(r, s) / t * 2,
                max: n + (e - h) / 2 / t * 2
              }
            };
            "m" === this.currentStick[0] ? (u.left = {
              min: Math.max(u.left.min, l.left.min),
              max: Math.min(u.left.max, l.left.max)
            }, u.right = {
              min: Math.max(u.right.min, l.right.min),
              max: Math.min(u.right.max, l.right.max)
            }) : "m" === this.currentStick[1] && (u.top = {
              min: Math.max(u.top.min, l.top.min),
              max: Math.min(u.top.max, l.top.max)
            }, u.bottom = {
              min: Math.max(u.bottom.min, l.bottom.min),
              max: Math.min(u.bottom.max, l.bottom.max)
            });
          }
        ...
        rectCorrectionByLimit: function (t) {
          var e = this.limits,
              ...
              o = t.newBottom,
              r = t.newTop;
          return n = this.sideCorrectionByLimit(e.left, n), i = this.sideCorrectionByLimit(e.right, i), r = this.sideCorrectionByLimit(e.top, r), o = this.sideCorrectionByLimit(e.bottom, o), {
            newLeft: n,
            newRight: i,
            newTop: r,
            newBottom: o
        ...
        rectCorrectionByAspectRatio: function (t) {
          ...
          if ("m" === a[1]) {
            ...
            var d = u - c.width;
            n -= d / h / 2, o -= d / h / 2;
          } else u / l > h ? (u = h * l, "l" === a[1] ? e = r - i - u : i = r - e - u) : (l = u / h, "t" === a[0] ? n = s - o - l : o = s - n - l);
      ...
      computed: {
        ...
        vdrStick: function () {
          ...
          return function (e) {
            ...
            return i[d.y[e[0]]] = "".concat(t.stickSize / t.parentScaleX / -2, "px"), i[d.x[e[1]]] = "".concat(t.stickSize / t.parentScaleX / -2, "px"), i;
          };
        },
        width: function () {
      ...
      watch: {
        ...
        m = p,
        v = (i(12), i(1)),
        g = Object(v.a)(m, l, f, !1, null, null, null);
    ...
    function u(t, e) {
      ...
      if (e.singleton) {
        var c = b++;
        i = g || (g = a(e)), n = l.bind(null, i, c, !1), o = l.bind(null, i, c, !0);
      } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = h(e), n = d.bind(null, i, e), o = function () {
        s(i), i.href && URL.revokeObjectURL(i.href);
      }) : (i = a(e), n = f.bind(null, i), o = function () {
        s(i);
      });
    ...
    function d(t, e, i) {
      ...
      (e.convertToAbsoluteUrls || r) && (n = x(n)), o && (n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
      var s = new Blob([n], {
        type: "text/css"
      }),
          a = t.href;
    ...
    i.r(e), function (t) {
      function n(t) {
        n.installed || (n.installed = !0, t.component("vue-drag-resize", o.a));
      }
      ...
      var o = i(2),
        ...
        install: n
          ...
          s = null;
      "undefined" != typeof window ? s = window.Vue : void 0 !== t && (s = t.Vue), s && s.use(r), e.default = o.a;
    }.call(this, i(5));
  }]);
});
...
//# sourceMappingURL=map.common.223.js.map